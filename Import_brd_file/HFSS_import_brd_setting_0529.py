...
# import_brd_file = r"D:\Project\Coupled_Inductor_For_OPPO\Input\V1_0510\oppo_couple_inductor_20210510_1600.brd"
# import_brd_file = r"D:\Project\Coupled_Inductor_For_OPPO\Input\V1_0510\com_test.brd"
# device_x = 1.6
# device_y = 1.6
...
import_design_setting.import_brd_trans1(oEditor)
...
# oDesktop.OpenProject("D:/Test/Dest20210604/HFSS_Dom_test.aedt")
...
oModule.DeleteBoundaries(["TOP_FC"])
oModule.DeleteBoundaries(["TOP_L1_FC"])
oModule.DeleteBoundaries(["TOP_L2_FC"])
oModule.DeleteBoundaries(["TOP_L3_FC"])	
...
oEditor.Subtract(
	[
		"NAME:Selections",
		"Blank Parts:="		, "L2_t_fill,L3_t_fill,L4_t_fill,L5_t_fill,UNNAMED_004,UNNAMED_006,UNNAMED_008",
		"Tool Parts:="		, "Mag_via"
	], 
	[
